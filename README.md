...
- Extension Pack for Java, da Microsoft (instala 6 extensões)<br>
    ![Microsoft Java Extension Pack](image.png)<br>
- Language Support for Java (tm), Red Hat<br>
    ![Red Hat Language Support for Java]<br>(image-1.png)
Opcionalmente, também se pode instalar os módulos<br>
- Java, Oracle Corporation<br>
    ![Java, Oracle](image-2.png)<br>
  Não é necessário para executar o código mas melhora o intelissense<br>
