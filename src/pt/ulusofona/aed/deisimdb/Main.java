...
//      diretores.clear();
//      generosFilmes.clear();
//      ficheirosInvalidos.clear();
//      filmes.clear();
//      votosDeFilmes.clear();
//      generos.clear();
//      MapIdFilmes.clear();
//      MapIdGenero.clear();
//      atorFilmesCorresp.clear();
//      diretorFilmesCorresp.clear();
//      filmesPorAno.clear();
//      atorIdsOcupados.clear();
//      diretoreIdsOcupados.clear();
    }
...
//          carregar actor se já existir, confirmando primeiro com o utilizador            
    ...
    public static String updateActor(int id, String nome, char gender, int movieId){
